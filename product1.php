...
<div class="text-section home-section">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="product-info">
                    ...
                    <div class="mt-3">
                        <label for="">SKU: woo-long-sleeve-tee Category: <span
                                class="pink-text">Ropping</span></label>
    ...
    <div class="tabs-blue">
        <div class="tab-blue active" onclick="showTab('description')">Description</div>
        <div class="tab-blue" onclick="showTab('info')">Additional Information</div>
        <div class="tab-blue" onclick="showTab('reviews')">Reviews (0)</div>
    </div>

    <div id="description" class="tab-blue-content active">
        <p>This is a product description.</p>
    </div>
    <div id="info" class="tab-blue-content">
        <p>Additional information about the product.</p>
    </div>
    <div id="reviews" class="tab-blue-content">
        <p>No reviews yet.</p>
    </div>
</div>
</div>
